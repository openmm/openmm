...
SKIP_METHODS = [('State', 'getPositions'),
                ...
                ('ApplyBussiThermostatKernel',),
                ('ApplyCavityDisplacementKernel',),
                ('ApplyConstraintsKernel',),
                ('ApplyMonteCarloBarostatKernel',),
                ('CalcCavityForceKernel',),
                ('CalcMultiModeCavityForceKernel',),
                ('MultiModeCavityForce', 'getCavityParticleIndices'),
                ('MultiModeCavityForce', 'getSpatialProfiles'),
                ('CavityForce', 'getLambdaCouplingSchedule'),
                ('CavityForce', 'setLambdaCouplingSchedule'),
                ('BondInfo',),
                ('BondParameterInfo',),
...
("*", "getDefaultTau") : ("unit.picosecond", ()),
("*", "setDefaultTau") : (None, ("unit.picosecond",)),
("*", "getOmegac") : (None, ()),
("*", "setOmegac") : (None, (None,)),
("*", "getLambdaCoupling") : (None, ()),
("*", "setLambdaCoupling") : (None, (None,)),
("*", "getPhotonMass") : (None, ()),
("*", "setPhotonMass") : (None, (None,)),
("*", "getCavityParticleIndex") : (None, ()),
("*", "setCavityParticleIndex") : (None, (None,)),
("*", "getSpringConstant") : (None, ()),
("*", "getEffectiveCoupling") : (None, ()),
("*", "getSwitchOnStep") : (None, ()),
("*", "setSwitchOnStep") : (None, (None,)),
("*", "getSwitchOnLambda") : (None, ()),
("*", "setSwitchOnLambda") : (None, (None,)),
("*", "hasTriggered") : (None, ()),
("CavityForce", "getLambdaCouplingSchedule") : (None, ()),
("CavityForce", "setLambdaCouplingSchedule") : (None, (None,)),
("*", "getHarmonicEnergy") : ("unit.kilojoule_per_mole", ()),
("*", "getCouplingEnergy") : ("unit.kilojoule_per_mole", ()),
("*", "getDipoleSelfEnergy") : ("unit.kilojoule_per_mole", ()),
("*", "getTotalCavityEnergy") : ("unit.kilojoule_per_mole", ()),
("*", "getCavityDriveEnergy") : ("unit.kilojoule_per_mole", ()),
("*", "getDirectLaserEnergy") : ("unit.kilojoule_per_mole", ()),
("*", "getCavityDriveAmplitude") : (None, ()),
("*", "getCavityDriveFrequency") : (None, ()),
("*", "getCavityDrivePhase") : (None, ()),
("*", "getCavityDriveEnvelopeParam1") : (None, ()),
("*", "getCavityDriveEnvelopeParam2") : (None, ()),
("*", "getDirectLaserAmplitude") : (None, ()),
("*", "getDirectLaserFrequency") : (None, ()),
("*", "getDirectLaserPhase") : (None, ()),
("*", "getDirectLaserEnvelopeParam1") : (None, ()),
("*", "getDirectLaserEnvelopeParam2") : (None, ()),
("*", "setCavityDriveAmplitude") : (None, (None,)),
("*", "setCavityDriveFrequency") : (None, (None,)),
("*", "setCavityDrivePhase") : (None, (None,)),
("*", "setDirectLaserAmplitude") : (None, (None,)),
("*", "setDirectLaserFrequency") : (None, (None,)),
("*", "setDirectLaserPhase") : (None, (None,)),
("*", "getLambdaCouplingAtStep") : (None, ()),
("*", "getCouplingOnStep") : (None, ()),
("*", "setCouplingOnStep") : (None, (None, None)),
("*", "getCouplingOnValue") : (None, ()),
("*", "getOmega1") : (None, ()),
("*", "getLambda1") : (None, ()),
("*", "getCavityLength") : ("unit.nanometer", ()),
("*", "getMoleculeZ") : ("unit.nanometer", ()),
("*", "getOmegaN") : (None, ()),
("*", "getLambdaN") : (None, ()),
("*", "getEffectiveCouplingN") : (None, ()),
("*", "getSpringConstantN") : (None, ()),
("*", "getSpatialProfile") : (None, ()),
("*", "getDSEPrefactor") : (None, ()),
("*", "getDisplacementFactor") : (None, ()),
("*", "getCombinedFactor") : (None, ()),
("*", "getNumModes") : (None, ()),
("*", "getApplyToAllParticles") : (None, ()),
("*", "setApplyToAllParticles") : (None, (None,)),
("*", "getParticle") : (None, ()),
("*", "addParticle") : (None, ()),
("*", "getFrequency") : (None, ()),
("*", "setFrequency") : (None, (None,)),
("*", "getUseDispersionCorrection") : (None, ()),
("*", "getWeight") : (None, ()),
("*", "getWeight12") : (None, ()),
("*", "getWeight13") : (None, ()),
...
("RPMDStochasticCellRescalingBarostat", "RPMDStochasticCellRescalingBarostat") : (None, ("unit.bar", "unit.picosecond", None)),
("RPMDStochasticCellRescalingBarostat", "getTauP") : ("unit.picosecond", ()),
("RPMDStochasticCellRescalingBarostat", "setTauP") : (None, ("unit.picosecond",)),
("RPMDStochasticCellRescalingBarostat", "getIsothermalCompressibility") : ("unit.bar**-1", ()),
("RPMDStochasticCellRescalingBarostat", "setIsothermalCompressibility") : (None, ("unit.bar**-1",)),
...
("RPMDIntegrator", "getThermostatType") : (None, ()),
("RPMDIntegrator", "setThermostatType") : (None, (None,)),
("RPMDIntegrator", "getCentroidFriction") : ("unit.picosecond**-1", ()),
("RPMDIntegrator", "setCentroidFriction") : (None, ("unit.picosecond**-1",)),
("RPMDIntegrator", "getParticleTypes") : (None, ()),
("RPMDIntegrator", "setParticleType") : (None, (None, None)),
("RPMDIntegrator", "getQuantumParticleTypes") : (None, ()),
("RPMDIntegrator", "setQuantumParticleTypes") : (None, (None,)),
("RPMDIntegrator", "getDefaultQuantum") : (None, ()),
("RPMDIntegrator", "setDefaultQuantum") : (None, (None,)),
("RPMDIntegrator", "getClassicalThermostat") : (None, ()),
    ("RPMDIntegrator", "setClassicalThermostat") : (None, (None,)),
    ("RPMDIntegrator", "getNumInnerSteps") : (None, ()),
    ("RPMDIntegrator", "setNumInnerSteps") : (None, (None,)),
    ("RPMDIntegrator", "getInnerForceGroups") : (None, ()),
    ("RPMDIntegrator", "setInnerForceGroups") : (None, (None,)),
    ("RPMDIntegrator", "getSuzukiChinEnabled") : (None, ()),
    ("RPMDIntegrator", "setSuzukiChinEnabled") : (None, (None,)),
    ("RPMDIntegrator", "getSuzukiChinEpsilon") : ("unit.nanometer", ()),
    ("RPMDIntegrator", "setSuzukiChinEpsilon") : (None, ("unit.nanometer",)),
...
("BussiThermostat", "getParticles") : (None, ()),
("BussiThermostat", "setParticles") : (None, (None,)),
