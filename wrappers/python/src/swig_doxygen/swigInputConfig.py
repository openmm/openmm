...
("LCPOForce", "addParticle") : (None, ("unit.nanometer", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**4")),
("LCPOForce", "getParticleParameters") : (None, ("unit.nanometer", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**4")),
("LCPOForce", "setParticleParameters") : (None, (None, "unit.nanometer", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**2", "unit.kilojoule_per_mole/unit.nanometer**4")),
