...
### This fork (UMA, batched PythonForce, RPMD)

For **this repository’s** ML/RPMD extensions, build-from-source issues, and regression tests documented in [README.md](README.md), prefer the **fork’s** issue tracker and discussions so context stays with the modified code.
