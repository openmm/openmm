...
set(stderr_log "/home/babaid/repos/openmm-puremd/reaxff_puremd/PuReMD/src/reaxff_puremd_build-stamp/reaxff_puremd_build-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/babaid/repos/openmm-puremd/reaxff_puremd/PuReMD/src/reaxff_puremd_build-stamp/reaxff_puremd_build-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "reaxff_puremd_build build command succeeded.  See also /home/babaid/repos/openmm-puremd/reaxff_puremd/PuReMD/src/reaxff_puremd_build-stamp/reaxff_puremd_build-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
