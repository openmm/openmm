...
SET(CC_FILE_DECLARATIONS)
SET(CC_FILE_DEFINITIONS)
CONFIGURE_FILE(${CC_SOURCE_DIR}/${CC_SOURCE_CLASS}.cpp.in ${CC_KERNELS_CPP})
FOREACH(file ${COMMON_KERNELS})
    ...
    FILE(RELATIVE_PATH filename ${CC_SOURCE_DIR}/kernels ${file})
    ...
    SET(CC_FILE_DECLARATIONS ${CC_FILE_DECLARATIONS}static\ const\ std::string\ ${variable_name};\n)
    FILE(APPEND ${CC_KERNELS_CPP} const\ string\ ${CC_SOURCE_CLASS}::${variable_name}\ =\ \"${file_content}\"\;\n)
ENDFOREACH(file)
CONFIGURE_FILE(${CC_SOURCE_DIR}/${CC_SOURCE_CLASS}.h.in ${CC_KERNELS_H})
